...
public class signupthree extends JFrame implements ActionListener {
    ...
    signupthree() {
      this.formno=formno;
        ...
        add(c6);
                 ...
                 c7=new JCheckBox("I hearby declare that the above entered details are corret to the best of my knowledge");
    ...
    public signupthree(String formno2) {
}
...
public void actionPerformed(ActionEvent ae) {
      if(ae.getSource()==submit){
            ...
            if(r1.isSelected()){
                  accountType="Saving acount";
            }
              else if(r2.isSelected()){
                  accountType="Fixed saving account";
            }
              else if(r3.isSelected()){
                  accountType="Current account";
            }
              else if(r4.isSelected()){
                  accountType="Recursive deposit account";
            }
